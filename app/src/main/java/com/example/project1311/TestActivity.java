...
/**
 * Quiz app that shows questions, tracks score, and saves high scores
 */
public class TestActivity extends AppCompatActivity implements View.OnClickListener {

    // Link to get quiz questions
    private String apiUrl = "https://mocki.io/v1/99f61a71-e82f-41e5-a997-aff49c49187e";
    ...
    private void getQuestionsFromInternet() {
        ...
        if (result != null && result.length() > 2) {
            try {
                ...
                e.printStackTrace();
                Toast.makeText(TestActivity.this, "Error reading the questions.", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(TestActivity.this, "Couldn't get questions from internet.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void showNextQuestion() {
        if (remainingQuestions.size() > 0) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(TestActivity.this, "Problem showing question.", Toast.LENGTH_SHORT).show();
            }
        } else {
